...
public class Tank {
	...
	static {
		tankImgs = new Image[] {
				tk.createImage(Tank.class.getClassLoader().getResource("tankD.gif")),		
				tk.createImage(Tank.class.getClassLoader().getResource("tankL.gif")),
				tk.createImage(Tank.class.getClassLoader().getResource("tankLD.gif")),
				tk.createImage(Tank.class.getClassLoader().getResource("tankLU.gif")),
				tk.createImage(Tank.class.getClassLoader().getResource("tankR.gif")),
				tk.createImage(Tank.class.getClassLoader().getResource("tankRD.gif")),				
				tk.createImage(Tank.class.getClassLoader().getResource("tankRU.gif")),				
				tk.createImage(Tank.class.getClassLoader().getResource("tankU.gif"))
		};
